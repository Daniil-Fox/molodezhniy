...
/* harmony import */ var _components_calc_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/calc.js */ "./src/js/components/calc.js");
...
const annualInterestDisplay = document.querySelector(".cta-form__inwrapper[data-after]");
...
loanAmountRange.oninput = function () {
  ...
  annualInterestInput.min = annualInterestRange.min * loanAmountInput.value / 100;
  annualInterestInput.max = annualInterestRange.max * loanAmountInput.value / 100;
  annualInterestInput.value = annualInterestRange.value * loanAmountInput.value / 100;
};
...
annualInterestRange.onchange = function () {
  ...
  annualInterestDisplay.dataset.after = Math.round(annualInterestInput.value / loanAmountInput.value * 100) + "%";
};
...
let ssSlider = null;
const tabs = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(".about-benefits__slider", {
  slidesPerView: "auto",
  spaceBetween: 10,
  freeMode: true,
  breakpoints: {
...
ssSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(".about-benefits__ss", {
  autoHeight: true,
  spaceBetween: 20,
  slidesPerView: 1,
  effect: "fade",
...
if (tabs.length > 0) {
  ...
  tabs.forEach((t, idx) => {
    t.addEventListener("click", e => {
      ...
      _sliders_js__WEBPACK_IMPORTED_MODULE_0__.ssSlider.slideTo(idx);
    });
  });
}
...
if (galleryContainer) {
  ...
  galleryItems.forEach((item, idx) => {
    _fancyapps_ui__WEBPACK_IMPORTED_MODULE_2__.Fancybox.bind(`[data-fancybox="gallery${idx}"]`, {});
  });
